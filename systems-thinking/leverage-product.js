(function () {
  ...
  productRoot.innerHTML='\
    <div class="lp-stack">\
      ...
      <section class="lp-card">\
        <div class="lp-section-heading"><div><span class="lp-kicker">What must be true</span><h3>A coherent operating capability behind the experience</h3></div><p class="text-small">The first product focus works only when information, authority, workflows, ownership, and learning operate together.</p></div>\
